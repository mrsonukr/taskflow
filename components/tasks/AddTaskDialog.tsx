...
export function AddTaskDialog({ open, onOpenChange }: AddTaskDialogProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      // Use selectedUsers directly, as they are User objects
      ...
      await createTask({
        ...
        createdBy: { id: currentUser.id, fullName: currentUser.fullName || "Unknown" },
        assignedTo,
      });
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {step === "users" ? "Select Users" : "Create New Task"}
          </DialogTitle>
          <DialogDescription>
            {step === "users"
              ? "Choose users to assign the task to"
